...
**Setup:**
```bash
./scripts/setup_deps.sh start   # starts Prometheus on port 9090
```
...
**Setup:**
```bash
./scripts/setup_deps.sh start   # starts Jaeger on port 16686
```
