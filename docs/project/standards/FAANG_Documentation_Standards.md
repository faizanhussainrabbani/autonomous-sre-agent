...
> [!NOTE]
> This document is a **companion** to [`engineering_standards.md`](./engineering_standards.md), which defines the detailed coding, testing, and architectural standards. This document focuses on the *organizational structure* of our documentation and how it aligns with industry best practices.
...
- [Engineering Standards & Code Organization](./engineering_standards.md) — Coding, testing, and architectural standards
- [CONTRIBUTING.md](../../../CONTRIBUTING.md) — Contributor guidelines
- [ADR Records](../ADRs/) — Architectural decisions
